...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            if let Err(e) = history::storage::init(app.handle()) {
                tracing::warn!(error = %e, "Failed to initialize history");
            }
        ...
        // Only commands the frontend actually invokes are exposed over IPC.
        .invoke_handler(tauri::generate_handler![
            ...
            commands::paths::get_default_output_dir,
